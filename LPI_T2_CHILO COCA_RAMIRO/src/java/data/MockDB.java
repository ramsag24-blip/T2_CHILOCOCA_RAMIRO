...
public class MockDB {
    ...
    static {
        ...
        PELICULAS.add(new Pelicula(1, "Rápidos al Límite", "Carreras y adrenalina.", 2022, 128, 1));
        PELICULAS.add(new Pelicula(2, "Risas en la Oficina", "Humor en el trabajo.", 2021, 98, 2));
        PELICULAS.add(new Pelicula(3, "Bajo la Lluvia", "Historia emotiva.", 2020, 115, 3));
    }
